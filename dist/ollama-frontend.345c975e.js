...
(function (e) {
  ...
  let l = {
    ...
    E = s(P, "u").replace(/punct/g, S).getRegex(),
    I = s(P, "u").replace(/punct/g, _).getRegex(),
    L =
    ...
    J = { normal: m, gfm: y, pedantic: $ },
    K = { normal: G, gfm: X, breaks: F, pedantic: U },
    V = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
    W = (e) => V[e];
  function Y(e, t) {
    if (t) {
...
${o}`
          ...
          if (h?.type === "blockquote") {
            ...
            (s[s.length - 1] = l),
              ...
              (r = r.substring(0, r.length - h.text.length) + l.text);
            break;
          }
          if (h?.type === "list") {
            let t = h.raw + "\n" + e.join("\n"),
            ...
            (s[s.length - 1] = l),
              (n = n.substring(0, n.length - h.raw.length) + l.raw),
              (r = r.substring(0, r.length - h.raw.length) + l.raw),
      ...
      if (t) {
        ...
        for (; e; ) {
            ...
            for (; e; ) {
              ...
              if (
                ...
                (i = this.options.pedantic
                  ...
                  : h.replace(this.rules.other.tabCharGlobal, "    ")),
                r.test(h) || s.test(h) || l.test(h) || t.test(h) || n.test(h))
              )
                break;
              if (i.search(this.rules.other.nonSpaceChar) >= u || !h.trim())
                o += "\n" + i.slice(u);
              else {
                if (
                  p ||
          ...
          !s.loose &&
            (i
              ? (s.loose = !0)
              : this.rules.other.doubleBlankLine.test(a) && (i = !0));
          let g = null;
          this.options.gfm &&
  ...
  class el {
    ...
    constructor(t) {
      ...
      let n = { other: l, block: J.normal, inline: K.normal };
      this.options.pedantic
        ? ((n.block = J.pedantic), (n.inline = K.pedantic))
        : this.options.gfm &&
          ((n.block = J.gfm),
    ...
    blockTokens(e, t = [], n = !1) {
      for (
        this.options.pedantic &&
        (e = e.replace(l.tabCharGlobal, "    ").replace(l.spaceLine, ""));
        e;
...
`
  ...
  class eh {
    ...
    parseMarkdown(e) {
      return (t, n) => {
        ...
        let i = s.hooks ? s.hooks.provideLexer() : e ? el.lex : el.lexInline,
          a = s.hooks ? s.hooks.provideParser() : e ? eo.parse : eo.parseInline;
        if (s.async)
          return Promise.resolve(s.hooks ? s.hooks.preprocess(t) : t)
            ...
            .then((e) =>
              s.walkTokens
                ? Promise.all(this.walkTokens(e, s.walkTokens)).then(() => e)
                : e,
            )
            .then((e) => a(e, s))
    ...
    onError(e, t) {
      return (n) => {
        if (
          ...
          let e =
            "<p>An error occurred:</p><pre>" + Y(n.message + "", !0) + "</pre>";
  ...
  (eu.options = eu.setOptions =
    function (e) {
      return ep.setOptions(e), (eu.defaults = ep.defaults), n(eu.defaults), eu;
    }),
    (eu.getDefaults = t),
    (eu.defaults = e.defaults),
    (eu.use = function (...e) {
      return ep.use(...e), (eu.defaults = ep.defaults), n(eu.defaults), eu;
    }),
...
async function l() {
  let r = n.value;
  if (!r) return;
  let l = await fetch("http://localhost:11434/api/generate", {
    method: "POST",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify({ model: s, prompt: r, stream: !0 }),
  });
  if (!l.ok || !l.body) {
    console.error("Error fetching response:", l.status, l.statusText),
  ...
  (c.innerHTML = `<strong>User:</strong> ${r}`), t.appendChild(c);
  let h = document.createElement("div");
  for (h.innerHTML = "<strong>Bot:</strong> ", t.appendChild(h); ; ) {
    let { value: t, done: n } = await i.read();
    if (n) break;
    for (let n of a
      .decode(t, { stream: !0 })
      .split("\n")
      ...
      try {
        ...
        t.response &&
          ((o += t.response),
          (h.innerHTML = `<strong>Bot:</strong><br>${e.marked.parse(o)}`));
      } catch (e) {
...
//# sourceMappingURL=ollama-frontend.345c975e.js.map
